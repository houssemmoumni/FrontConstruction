...
@Component({
    ...
    styleUrl: './portfolio-grid2.component.css'
})
export class PortfolioGrid2Component {


  banner: any = {
    pagetitle: "Portfolio Grid 2 Icon",
    bg_image: "assets/images/banner/bnr4.jpg",
    title: "Portfolio Grid 2 Icon",
  }
  scroll_top() {
    window.scroll({
      top: 0,
  ...
  portolio_grid = [
    {
      class_name: "col-lg-6",
      ul_class: "portfolio-ic dlab-gallery-listing gallery-grid-4 lightgallery text-center",
      grids: [
        {
