...
@Component({
  ...
  templateUrl: './NegociationList.component.html',
  styleUrls: ['./NegociationList.component.scss'],
  standalone: true,
  imports: [
    CommonModule,
    MatTableModule,
...
export class NegociationList implements OnInit, AfterViewInit {
  ...
  private loadNegociations() {
    ...
    this.http.get<Negociation[]>(`http://localhost:8890/gestionnegociation/api/phase1/negociations/ByID/${id}`)
      .pipe(
