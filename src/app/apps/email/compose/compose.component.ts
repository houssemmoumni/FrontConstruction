...
export class ComposeComponent {
    ...
    sendEmail(): void {
        ...
        this.financialReportService.sendFinancialReport(report).subscribe(
            ...
            (error) => {
                this.errorMessage = 'Failed to send the email. Please try again.';
