...
import { TeamMembersComponent } from './pages/users/team-members/team-members.component';
...
export const routes: Routes = [
  ...
  { path: 'auth', loadChildren: () => import('./pages/auth/authentication/authentication.module').then(m => m.AuthenticationModule) },
