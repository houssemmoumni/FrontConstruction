import { Routes } from '@angular/router';
    ...
    import { ChatComponent } from './front/pages/Negociation/CH/app/components/chat/chat.component';
    import { ChatService } from './front/pages/Negociation/CH/app/services/chat.service';
   // Import ChatComponent
    ...
    export const routes: Routes = [
        ...
        { path: 'negociation-all-list', component: NegociationAllListComponent },
        ...
        { path: 'chat', component: ChatComponent }, // Add route for ChatComponent
