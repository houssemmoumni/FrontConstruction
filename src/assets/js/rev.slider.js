var dzrevapi;
var dzQuery =jQuery;
var pluginPath ="assets/plugins/revolution/revolution/js/";
...
function dz_rev_slider_3(){
	if(dzQuery("#rev_slider_14_1").revolution == undefined){
		...
		dzrevapi = dzQuery("#rev_slider_14_1").show().revolution({
			...
			navigation: {},
			responsiveLevels:[1240,1191,778,480],
			visibilityLevels:[1240,1191,778,480],
			gridwidth:[1240,1191,778,480],
			gridheight:[920,768,720,720],
			lazyType:"none",
			parallax: {
				type:"mouse",
				origo:"slidercenter",
